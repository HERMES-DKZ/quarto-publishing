...
The Lesson is subdivided into several parts:
  - A brief Introduction into Quarto and its history
  - A guide through Quartos basic features and tools. This includes the Markdown language, YML headers and the implementation of python-based code.
  - A guide on how to convert a PDF based Quarto document into a html-based website
  - An introduction into the build-in bibliography feature and its tools
